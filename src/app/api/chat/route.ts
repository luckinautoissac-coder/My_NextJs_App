...
- **层门及门套:**
    - 标配：首层：发纹不锈钢，其他楼层：喷涂钢板（不加价）。**报价默认标配**，如客户要求，全层不锈钢，加价为：（全层-1）+300元/层。举例，客户要求6层全不锈钢，则加价为：（6-1）*300=1500元
- **观光梯说明:**
...
- Country: China
- Brand: FUJICL– Military-Grade Lifts. Since 1966.
- Main Products: Specialize in two main product series—elevators and escalators—covering everything from standard models to custom non-standard solutions tailored to individual client needs.
...
- 公司优势：
  1. 近60年工程沉淀：专业可靠，始于基因
  2. 强大的非标定制能力：将特殊构想变为现实
  3. 从工厂到现场的全程保障：项目成功交付
  4. 极致性价比：每一分钱都投在产品硬实力上
  5. 超长核心质保：5年质保，远超行业标准

- Target customer types: 地产开发商、商业设施业主、战略情报伙伴、海外代理商、建筑设计师、工业客户、政府采购、物业公司、线上直采客户、电梯维保同行等。
